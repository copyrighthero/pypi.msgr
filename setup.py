...
from msgr import __author__, __license__, __version__
...
setup(
  name = 'Msgr',
  version = __version__,
  description = 'A Python messaging library.',
  long_description = PROJECT_README,
  url = 'https://www.github.com/copyrighthero/Msgr',
  download_url = 'https://www.github.com/copyrighthero/Msgr',
  author = __author__,
  ...
  keywords = 'Python Messaging Library',
  py_modules = ("msgr", ),
  ...
  entry_points = {},
  project_urls = {
    'Source': 'https://www.github.com/copyrighthero/Msgr'
  }
)
